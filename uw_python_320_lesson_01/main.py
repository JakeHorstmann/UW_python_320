...
def add_user(user_id, email, user_name, user_last_name, user_collection):
    ...
    - Otherwise, it returns True.
    '''
    # check if user is already in the user collection
    if not user_id in user_collection.database:
    ...
    # return False if already in database
    return False
...
def update_user(user_id, email, user_name, user_last_name, user_collection):
    ...
    - Otherwise, it returns True.
    '''
    # check to make sure user is in the user collection
...
def add_status(user_id, status_id, status_text, status_collection):
    ...
    - Otherwise, it returns True.
    '''
    # check if status is already in the status collection
    if not status_id in status_collection.database:
        # make sure none of the values are blank
...
def update_status(status_id, user_id, status_text, status_collection):
    ...
    - Otherwise, it returns True.
    '''
    # check to make sure status is in the status collection
