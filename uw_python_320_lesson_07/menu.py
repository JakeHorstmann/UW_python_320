...
def load_users_multiprocess():
    '''
    Loads user accounts from a file with multiprocessing
    '''
    filename = input('Enter filename of user file: ')
    main.load_users_multiprocess(filename)
...
def load_status_updates_multiprocess(processors = 1):
    '''
    Loads status updates from a file with multiprocessing
    '''
    filename = input('Enter filename for status file: ')
    main.load_status_updates_multiprocess(filename)
...
if __name__ == '__main__':
    ...
    user_collection = main.init_user_collection(host, port, database_name)
    status_collection = main.init_status_collection(host, port)
    menu_options = {
        'A': load_users,
